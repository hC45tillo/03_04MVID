...
uint32_t createVertexData(uint32_t* VBO, uint32_t* EBO, int triangles) {
...
int main(int, char* []) {
	...
	uint32_t VBOA,VBOB, EBO;
	const uint32_t VAOA = createVertexData(&VBOA, &EBO, 1);
	const uint32_t VAOB = createVertexData(&VBOA, &EBO, 2);
