...
void render(const Geometry& object, const Geometry& light, const Shader& s_phong, const Shader& s_light) {
	...
	s_phong.set("material.shininess", 0.6f * 128);
	...
	glm::inverse(glm::transpose(glm::mat3(model)));
	s_phong.set("normalMat", normalMat);
	...
	// ruby
	s_phong.set("material.ambient", 0.1745f, 0.01175f, 0.01175f);
	s_phong.set("material.diffuse", 0.61424f, 0.04136f, 0.04136f);
	s_phong.set("material.specular", 0.727811f, 0.626959f, 0.626959f);
	s_phong.set("material.shininess", 0.6f * 128);
