...
void render(const Geometry& object, const Geometry& light, const Shader& s_phong, const Shader& s_light) {
	...
	// Al modificar jugamos con los reflejos y la luz, hace que sea mas claro o mas oscuro, permitiendo abarcar mas sombra o menos
	// ----
    s_phong.set("ambientStrength", 0.6f);
    s_phong.set("lightPos", lightPos);

    s_phong.set("viewPos", camera.getPosition());
	// ----
    s_phong.set("shininess", 80);
