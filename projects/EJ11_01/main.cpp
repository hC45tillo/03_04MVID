...
void render(const Geometry& floor, const Geometry& object, const Shader& s_phong, const Shader& s_blend, 
	...
	//TODO: volverlo un ciclo anidado
	for (const auto& cubePos : cubePositions) {

			s_blend.use();
			model = glm::mat4(1.0f);
			model = glm::translate(model, glm::vec3(cubePos.x - 0.50f, cubePos.y, 1.01f));
			...
			s_blend.use();
			model = glm::mat4(1.0f);
			model = glm::translate(model, glm::vec3(cubePos.x, cubePos.y, 1.02f));
			s_blend.set("model", model);
			s_blend.set("view", view);
			s_blend.set("proj", proj);
			...
			s_blend.use();
			model = glm::mat4(1.0f);
			model = glm::translate(model, glm::vec3(cubePos.x + 0.50f, cubePos.y, 1.03f));
			s_blend.set("model", model);
			s_blend.set("view", view);
			s_blend.set("proj", proj);
...
int main(int, char* []) {
	...
	const Texture t_albedo("../assets/textures/wood2.jpg", Texture::Format::RGB);
	const Texture t_specular("../assets/textures/wood2.jpg", Texture::Format::RGB);
    const Texture t_tree("../assets/textures/grass.png", Texture::Format::RGBA);
